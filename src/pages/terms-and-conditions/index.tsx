...
export default function TermsAndConditions() {
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold mb-8">Website Terms and Conditions</h1>
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            The Service and its original content, features, and functionality are owned by Yallburru 
            Community Services and are protected by international copyright, trademark, patent, trade 
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            controlled by Yallburru Community Services. We have no control over and assume no 
        ...
        <section className="mb-8">
          ...
          <p>
            In no event shall Yallburru Community Services, its directors, employees, partners, agents, 
