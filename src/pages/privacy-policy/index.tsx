  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="prose max-w-none">
        <p className="mb-6">Last updated: December 19, 2024</p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Introduction</h2>
          <p>
            Yallburru Community Services (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy. 
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li>Enquiry and feedback forms</li>
            <li>Service request information</li>
          </ul>

          <h3 className="text-xl font-semibold mb-3">Information Automatically Collected</h3>
          <p>When you visit our website, we may automatically collect certain information about your device and usage of the website, including:</p>
          <ul className="list-disc ml-6 mb-4">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-6 mb-4">
            <li>Service providers and third parties that assist us in operating our website</li>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            experience. You can set your browser to refuse all or some browser cookies or to alert 
        ...
        <section className="mb-8">
          ...
          <p>Under Australian privacy law, you have certain rights regarding your personal information, including:</p>
          <ul className="list-disc ml-6 mb-4">
        ...
        <section className="mb-8">
          ...
          <p>
            Your information may be transferred to and processed in computers located outside of your 
            state, province, country, or other governmental jurisdiction where data protection laws may differ.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Australian Privacy Principles</h2>
          <p>
